...
int main()
{
  ...
  printf("the actual values of the semaphores are %d, %d, %d\n", \
    ...
    //here, we are attempting to decrement critical section sem
    //and filled counting sem, atomically - if either cannot be 
    //decremented, semop() will block - the most likely case
    //when this semop() will block is there are no filled slots 
    //and corresponding sem value is 0 !!!
   ...
   //and third semaphore are decremented !!!
    ...
    //here we increment fre slot semaphore and this is nothing 
    //but transformation of a filled slot to a free slot !!! 
