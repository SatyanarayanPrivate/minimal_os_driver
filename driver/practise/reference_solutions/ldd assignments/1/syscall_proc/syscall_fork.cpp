...
# 1 "/usr/lib/gcc/i586-suse-linux/4.3/include/stdarg.h" 1 3 4
# 43 "/usr/lib/gcc/i586-suse-linux/4.3/include/stdarg.h" 3 4
...
# 1 "/usr/lib/gcc/i586-suse-linux/4.3/include/stddef.h" 1 3 4
# 326 "/usr/lib/gcc/i586-suse-linux/4.3/include/stddef.h" 3 4
...
long test_call(unsigned int* pid,unsigned int * tgid) { long __res; __asm__ volatile ("push %%ebx ; movl %2,%%ebx ; int $0x80 ; pop %%ebx" : "=a" (__res) : "0" (327),"ri" ((long)(pid)),"c" ((long)(tgid)) : "memory"); do { if ((unsigned long)(__res) >= (unsigned long)(-4095)) { (*__errno_location ()) = -(__res); __res = -1; } return (long) (__res); } while (0); }
