...
//if this macro is invoked with appropriate parameters, it actually 
//builds a wrapper function for our system call - basically, this 
//wrapper is our system call API !!!
